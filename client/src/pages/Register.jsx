  ...
  const handleRegister = async (data) => {
    try {
      await registerUser({
        ...
        role: data.isAdmin ? "Administrator" : "Member",
        title: data.isAdmin ? "Admin" : "Team Member",
      }).unwrap();
          ...
          >
            ...
            <div className='flex flex-col gap-y-5'>
              ...
              <div className='flex items-center gap-3'>
                ...
                />
                <label htmlFor='isAdmin' className='text-sm text-gray-700 dark:text-gray-400 cursor-pointer'>
                  Register as Admin
                </label>
              </div>
            </div>
